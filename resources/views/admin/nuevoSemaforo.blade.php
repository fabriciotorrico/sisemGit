                ...
                <div class="widget-content nopadding">
                  ...
                  <form action="#" method="get" class="form-horizontal">
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" class="span11" placeholder="Latitud" />
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">Longitud:</label>
                      <div class="controls">
                        <input type="text" class="span11" placeholder="Longitud" />
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">Tiempo Rojo:</label>
                      <div class="controls">
                        <input type="password"  class="span11" placeholder="Tiempo Rojo"  />
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">Tiempo Amarillo:</label>
                      <div class="controls">
                        <input type="text" class="span11" placeholder="Tiempo Amarillo" />
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">Tiempo Verde:</label>
                      <div class="controls">
                        <input type="text" class="span11" placeholder="Tiempo Verde" />
                    </div>
                    <div class="control-group">
